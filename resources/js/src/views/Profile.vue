    ...
    <div>
        <b-form @submit.prevent="updateInfo">
            <b-form-group label="الاسم بالكامل" label-for="name">
                <b-form-input id="name" v-model="formInfo.name" />
            </b-form-group>
            <b-form-group label="البريد الالكتروني" label-for="email">
                <b-form-input id="email" v-model="formInfo.email" />
            </b-form-group>
            <b-form-group label="الدولة" label-for="country">
                <b-form-select id="country" v-model="formInfo.country">
        ...
        <b-form @submit.prevent="updatePassword">
            <b-form-group label="كلمة المرور الحالية" label-for="curr_pass">
                <b-form-input
                    id="curr_pass"
                    type="password"
            ...
            <b-form-group label="كلمة المرور الجديدة" label-for="new_pass">
                <b-form-input
                    id="new_pass"
                    type="password"
...
export default {
    ...
    methods: {
        updateInfo() {
            axios
                .post("/api/admin/update-profile", this.formInfo, {
                    headers: {
                ...
                .then((result) => {
                    alert("تم تحديث بياناتك الشخصية"),
        ...
        updatePassword() {
            axios
                .post("/api/admin/update-password", this.formPass, {
                    headers: {
                        token: JSON.parse(localStorage.getItem("MatarAdmin"))
                            .token,
                    },
